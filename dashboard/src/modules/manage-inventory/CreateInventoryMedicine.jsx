...
import useCreateInventoryMedicine from "./useCreateInventoryMedicine";
import { useNavigate } from "react-router-dom";

const CreateInventoryMedicine = () => {
  ...
  return (
    <div>
      <TitleSection>Lập phiếu nhập thêm vật tư y tế</TitleSection>

      <div className="mt-10 space-y-8 w-full max-w-6xl mx-auto">
        <div className="flex flex-col gap-2">
          <label>Nhà cung cấp vật tư y tế</label>
          <Dropdown
            options={suppliers}
            filter
        ...
        <div className="space-y-5">
          <h1 className="text-2xl font-semibold">
            Danh sách vật tư y tế cần nhập
          </h1>
          <DataTable
            scrollable
            stripedRows
...
export default CreateInventoryMedicine;
