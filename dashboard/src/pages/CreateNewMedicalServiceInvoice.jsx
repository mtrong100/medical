...
import { createNewMedicalServiceInvoiceApi } from "../api/medicalServiceInvoiceApi";

const CreateNewMedicalServiceInvoice = () => {
  ...
  const handleCreateNewMedicalServiceInvoice = async () => {
    ...
    try {
      ...
      const res = await createNewMedicalServiceInvoiceApi(body);
      ...
      console.log("Error creating new medical service invoice:", error);
      toast.current.show({
        severity: "error",
        summary: "Lỗi",
        life: 1500,
      ...
      setPatient("");
      setSelectedStatus(PAYMENT_STATUS.UNPAID);
    }
  };
  ...
  return (
    <div>
      ...
      <div className="flex items-center justify-end gap-3 mt-8">
        ...
        />
        <Button
          onClick={handleCreateNewMedicalServiceInvoice}
          type="submit"
          label="Xác nhận"
          disabled={loading}
          className="w-[200px]"
...
export default CreateNewMedicalServiceInvoice;
